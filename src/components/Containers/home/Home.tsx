...
export const Home = () => {
  ...
  const executeScroll = () => {
    rulebookRef.current &&
      rulebookRef.current.scrollIntoView({ behavior: "smooth" });
  };
    ...
    <div className="home">
      <div className="home__header">
        ...
        <div className="home__header__container">
          <div className="home__header__container__title">Portへようこそ！</div>
          <Button
            className="rulebook-link"
            size="large"
            variant="text"
            startIcon={<MenuBookIcon />}
            onClick={() => handleRuleBookClick(true)}
          >
            ルールブックを読む
          </Button>
        </div>
      ...
      <div className="home__body">
        <div className="home__body__content">
          {showRulebook && (
            <Paper
              className="expandable-rule-card"
              elevation={3}
              ref={rulebookRef}
            >
              <div className="rule-text">
                <ul>
                  ...
                  <li>
                    他のメンバーのプライバシーに関することを Twitter などの SNS
                    や他の場所でシェアしない。
                  </li>
                  <li>
                  ...
                  <li>
                    アジア人女性、ノンバイナリーとしては tech
                    でマイノリティであっても、コミュニティの中ではジェンダーやセクシュアリティ、家庭環境などそれぞれ別の面でマジョリティであり特権もあって、みんなが同じわけではありません。このコミュニティには色んな境遇の人がいること、誰もが何かの面ではマジョリティで差別の加害者になり得ることを忘れないでください。
                  </li>
                  <li>
              ...
              <Button
                className="close-rulebook-button"
                variant="outlined"
                onClick={() => handleRuleBookClick(false)}
              >
                閉じる
              </Button>
            </Paper>
        ...
        <a
          ...
          href="https://www.freepik.com/vectors/summer-time"
        >
          Background image credit: Summer time vector created by rawpixel.com -
          www.freepik.com
        </a>
      </div>
    </div>
